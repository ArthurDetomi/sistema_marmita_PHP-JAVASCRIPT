...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/sistemamarmita/admin/users">Usuários</a></li>
    <li class="active"><a href="/sistemamarmita/admin/users/create">Cadastrar</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/sistemamarmita/admin/users/create" method="post">
          <div class="box-body">
